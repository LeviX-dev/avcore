...
//   // Mini mode: sidebar shrinks to icon-only, stays in same position
//   const [mini, setMini] = useState(false);

//   // Tooltip state for mini mode
...
//     if (mini) return; // no dropdowns in mini mode
...
//   // Close on outside click (mobile overlay behaviour kept)
//   useEffect(() => {
...
//       'dash board': <LayoutDashboard className="w-5 h-5 flex-shrink-0" />,
...
//       'add user': <UserPlus className="w-5 h-5 flex-shrink-0" />,
//       'user list': <List className="w-5 h-5 flex-shrink-0" />,
//       'employee wise report': <Users className="w-5 h-5 flex-shrink-0" />,
//       'employee work report': <UserCog className="w-5 h-5 flex-shrink-0" />,
//       'employeewise report': <Users className="w-5 h-5 flex-shrink-0" />,
//       'role permission': <ShieldCheck className="w-5 h-5 flex-shrink-0" />,
//       campaign: <Megaphone className="w-5 h-5 flex-shrink-0" />,
//       'create campaign': <FolderPlus className="w-5 h-5 flex-shrink-0" />,
//       'view campaign': <Eye className="w-5 h-5 flex-shrink-0" />,
//       'assigned call': <PhoneOutgoing className="w-5 h-5 flex-shrink-0" />,
//       'assigned calls': <PhoneOutgoing className="w-5 h-5 flex-shrink-0" />,
//       "today's task": <CheckSquare className="w-5 h-5 flex-shrink-0" />,
//       'todays task': <CheckSquare className="w-5 h-5 flex-shrink-0" />,
//       'today task': <CheckSquare className="w-5 h-5 flex-shrink-0" />,
//       'missed follow up list': <ClipboardList className="w-5 h-5 flex-shrink-0" />,
//       'missed follow-up list': <ClipboardList className="w-5 h-5 flex-shrink-0" />,
//       'upcoming follow ups': <CalendarDays className="w-5 h-5 flex-shrink-0" />,
//       'upcoming follow-ups': <CalendarDays className="w-5 h-5 flex-shrink-0" />,
//       report: <BarChart3 className="w-5 h-5 flex-shrink-0" />,
//       reports: <BarChart3 className="w-5 h-5 flex-shrink-0" />,
//       'attendance report': <CalendarCheck className="w-5 h-5 flex-shrink-0" />,
//       'drop leads report': <Eye className="w-5 h-5 flex-shrink-0" />,
//       'closed leads report': <CheckCircle className="w-5 h-5 flex-shrink-0" />,
//       'leadwise report': <TrendingUp className="w-5 h-5 flex-shrink-0" />,
//       'lead wise report': <TrendingUp className="w-5 h-5 flex-shrink-0" />,
//       'meta leads report': <Package className="w-5 h-5 flex-shrink-0" />,
//       statistics: <BarChart3 className="w-5 h-5 flex-shrink-0" />,
//       execution: <TrendingUp className="w-5 h-5 flex-shrink-0" />,
//       'pre execution': <Clock className="w-5 h-5 flex-shrink-0" />,
//       'complete execution': <CheckCircle className="w-5 h-5 flex-shrink-0" />,
//       'assigned procress': <CalendarCheck className="w-5 h-5 flex-shrink-0" />,
//       'assigned process': <CalendarCheck className="w-5 h-5 flex-shrink-0" />,
//       'daily operations': <ClipboardCheck className="w-5 h-5 flex-shrink-0" />,
//       'process type': <GitBranch className="w-5 h-5 flex-shrink-0" />,
//       schedule: <Calendar className="w-5 h-5 flex-shrink-0" />,
//       'managed execution': <ClipboardCheck className="w-5 h-5 flex-shrink-0" />,
//       stock: <Warehouse className="w-5 h-5 flex-shrink-0" />,
//       inword: <Boxes className="w-5 h-5 flex-shrink-0" />,
//       inward: <Boxes className="w-5 h-5 flex-shrink-0" />,
//       mrn: <FileStack className="w-5 h-5 flex-shrink-0" />,
//       'generate mrn': <FileStack className="w-5 h-5 flex-shrink-0" />,
//       'verify mrn': <CheckCircle className="w-5 h-5 flex-shrink-0" />,
//       'approve mrn': <CheckCircle className="w-5 h-5 flex-shrink-0" />,
//       'manage mrn': <Clipboard className="w-5 h-5 flex-shrink-0" />,
//       'daily operation': <Activity className="w-5 h-5 flex-shrink-0" />,
//       'quotation template': <FileText className="w-5 h-5 flex-shrink-0" />,
//       quotation: <FileText className="w-5 h-5 flex-shrink-0" />,
//       quotations: <FileText className="w-5 h-5 flex-shrink-0" />,
//       category: <FolderOpen className="w-5 h-5 flex-shrink-0" />,
//       categories: <FolderOpen className="w-5 h-5 flex-shrink-0" />,
//       product: <Package className="w-5 h-5 flex-shrink-0" />,
//       products: <Package className="w-5 h-5 flex-shrink-0" />,
//       sources: <Bookmark className="w-5 h-5 flex-shrink-0" />,
//       references: <Bookmark className="w-5 h-5 flex-shrink-0" />,
//       city: <Map className="w-5 h-5 flex-shrink-0" />,
//       areas: <Map className="w-5 h-5 flex-shrink-0" />,
//       kit: <Package className="w-5 h-5 flex-shrink-0" />,
//       kits: <Package className="w-5 h-5 flex-shrink-0" />,
//       logout: <LogOut className="w-5 h-5 flex-shrink-0" />,
//       'sign out': <LogOut className="w-5 h-5 flex-shrink-0" />,
//       add: <Plus className="w-5 h-5 flex-shrink-0" />,
//       create: <Plus className="w-5 h-5 flex-shrink-0" />,
//       new: <Plus className="w-5 h-5 flex-shrink-0" />,
//       view: <Eye className="w-5 h-5 flex-shrink-0" />,
//       list: <List className="w-5 h-5 flex-shrink-0" />,
//       manage: <Settings className="w-5 h-5 flex-shrink-0" />,
//       settings: <Settings className="w-5 h-5 flex-shrink-0" />,
//       profile: <UserCog className="w-5 h-5 flex-shrink-0" />,
//     };
...
//       // In mini mode: parent acts as a direct link to first child (or shows tooltip)
//       if (mini) {
//         return (
//           <li key={menu.menu_key}>
//             <div
...
//             >
//               {getIcon(menu.label)}
//               {/* Small arrow to indicate children */}
...
//           style={{ top: tooltip.y, left: mini ? 68 : 290, transform: 'translateY(-50%)' }}
//         >
...
//           /* Desktop: always visible, just changes width */
...
//           }`}
//         >
//           {/* Logo — hidden in mini, shown in full */}
//           {!mini && (
...
//           {/* Mini mode: just show small logo mark */}
//           {mini && (
  ...
  const getIconByKey = (menuKey: string, label: string): React.ReactNode => {
    ...
    const keyIconMap: Record<string, React.ReactNode> = {
      ...
      execution_dashboard: <Activity className="w-5 h-5 flex-shrink-0" />,
          mrn_dashboard: <TrendingUp  className="w-5 h-5 flex-shrink-0" />,  // ← ADD THIS LINE
