...
const ECommerce: React.FC = () => {
  ...
  const shouldShowQuotationFollowup = isAuthenticated;
  ...
  const quotationProjectionCards = [
      ...
      ? [
          {
            ...
            onClick: () =>
              navigate('/call', {
                state: { filterStage: 'Quotation Pending' },
              }),
            clickable: true,
          },
        ]
      ...
      ? [
          {
            ...
            onClick: () =>
              navigate('/call', {
                state: { filterStage: 'Quotation Follow-up' },
              }),
            clickable: true,
          },
        ]
      ...
      ? [
          {
            ...
            onClick: () =>
              navigate('/call', {
                state: { filterStage: 'Projection List' },
              }),
            clickable: true,
          },
        ]
