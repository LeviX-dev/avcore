...
//       // Also fetch all master data for details
...
//   // Fetch all master data once and cache it
...
//       // Create a map for quick lookup by master_id
//       const clientMap = new Map();
//       response.data.forEach((client: any) => {
//         clientMap.set(client.master_id, {
//           master_id: client.master_id,
//           name: client.name,
//           number: client.number,
//           email: client.email,
//           address: client.address,
//           city: client.city || client.area_name,
//           area: client.area_name,
//           cat_name: client.cat_name,
//           category_other: client.category_other,
//           reference_name: client.reference_name,
//           reference_other: client.reference_other,
//           assigned_to: client.assigned_to,
//           lead_stage: client.lead_stage,
//           stage: client.stage,
//           latest_leadStage: client.latest_leadStage,
//           quick_remark: client.quick_remark,
//           detailed_remark: client.detailed_remark,
//           assign_date: client.assign_date,
//           followup_date: client.followup_date,
//           site_visit_date: client.site_visit_date,
//           demo_date: client.demo_date,
//           budget_range: client.budget_range,
//           p_type: client.p_type,
//           room_length: client.room_length,
//           room_width: client.room_width,
//           room_height: client.room_height,
//           room_ready: client.room_ready,
//           time_to_complete: client.time_to_complete,
//           document_location_link: client.document_location_link,
...
//   // Handle client name click - get details from cached data
//   const handleClientNameClick = async (client: QuotationLead) => {
//     // Try to get details from cached master data
...
//     } else {
//       // Fallback: create basic details from the lead data
//       setSelectedClient({
//         master_id: client.master_id,
//         name: client.name,
//         number: client.number,
...
//   // Handle tab change to fetch documents
...
//                             {formatValue(selectedClient.detailed_remark)}
//                           </div>
//                         </div>
//                       )}
//                     </div>
...
//                     {/* Client Details - Clickable Name */}
//                     <td className="py-3 px-4">
//                       <div className="flex flex-col">
//                         <button
//                           onClick={() => handleClientNameClick(row)}
//                           className="font-bold text-gray-900 dark:text-white text-sm mb-1 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200 text-left cursor-pointer"
//                         >
//                           {row.name}
//                         </button>
//                         {row.city && (
...
const QuotationPending = () => {
  ...
  // Fetch all master data with proper parsing of remarks and stages
  const fetchAllMasterData = async () => {
    try {
      const response = await axios.get(`${BASE_URL}api/master-data`, {
        withCredentials: true,
      ...
      // Track last non-drop stages
      const lastNonDropStages: Record<number, string> = {};
      
      // First pass: Identify last non-drop stages
  ...
  const handleClientNameClick = async (client: QuotationLead) => {
    ...
    if (cachedDetails) {
      ...
      // Fetch individual client details if not in cache
      try {
  ...
  // Render Details Modal with all remarks
  const renderDetailsModal = () => {
    if (!selectedClient) return null;
